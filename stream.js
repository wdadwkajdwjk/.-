...
srcUrl = 'https://piratestream.ml/plr.html';
iframe1.src = srcUrl;
iframe1.id = 'rk';
iframe1.style = 'width="auto" height="auto" frameborder="0" scrolling="no" autoplay="1" overflow-y: hidden; overflow-x: hidden;';
...
const ChangeFile2 = () => {
    srcUrl = 'https://piratestream.ml/plr2.html';
    iframe1.src = srcUrl;
}
file2.addEventListener('click', ChangeFile2);
const ChangeFile3 = () => {
    srcUrl = 'https://piratestream.ml/plr3.html';
    iframe1.src = srcUrl;
}
